    ...
    <div id="sec-16" data-os-read-marker className="os-surface border-x-4 border-b-4 border-black">
      <div className="os-section-head-row os-section-head--orange">
        <div className=" min-w-0 flex-1">
          <SectionEyebrow index={14} label={sectionNavLabel(14)} tone="light" />
          <h2 className="os-section-h2">LAS EXCURSIONES QUE HICIERON HISTORIA</h2>
        </div>
      </div>
          ...
          <div className="p-6 sm:p-8 lg:p-10 xl:p-12">
            <div className="border-l-2 border-[var(--os-orange)] pl-5 sm:pl-6">
              ...
              <div className="space-y-4 text-base leading-relaxed lg:text-lg xl:text-xl">
                ...
                <p>
                  Centro Cívico, activación de grupo, búsqueda del tesoro y después Circuito Chico
                  entre lagos, bosques y curvas de postal.
                </p>
                <p className="font-black text-lg lg:text-xl xl:text-2xl">
          ...
          <div className="border-b-2 border-black p-6 sm:p-8 lg:border-b-0 lg:border-r-2 lg:p-10 xl:p-12">
            <div className="border-l-2 border-[var(--os-orange)] pl-5 sm:pl-6">
              ...
              <div className="space-y-4 text-base leading-relaxed lg:text-lg xl:text-xl">
                ...
                <p className="font-black text-lg lg:text-xl xl:text-2xl">
                  Y cuando parece que el día terminó, lo cerramos con sunset cervecero y show en
                  vivo.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-4xl">
          <div className="border-l-2 border-[var(--os-cyan)] pl-5 sm:pl-6">
            ...
            <div className="space-y-4 text-base leading-relaxed lg:text-lg xl:text-xl">
              ...
              <p>
                Propuesta gastronómica de montaña, pileta climatizada convertida en discoteca,
                fiesta de la espuma, DJs en vivo, happy hours, <OldSchoolWord registered={false} />{' '}
                Rock y cierre con Sunset We Color.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl">
          <div className="border-l-2 border-[var(--os-orange)] pl-5 sm:pl-6">
            ...
            <div className="space-y-4 text-base leading-relaxed lg:text-lg xl:text-xl">
              ...
              <p>
                Aerosilla, charla rápida de seguridad, circuito armado, risas, montaña y diversión
                real.
              </p>
              <p className="font-black text-lg lg:text-xl xl:text-2xl">
          ...
          <div className="flex flex-col justify-center p-6 sm:p-8 lg:p-10 xl:p-12">
            <div className="border-l-2 border-black pl-5 sm:pl-6">
              ...
              <div className="space-y-4 text-base leading-relaxed lg:text-lg xl:text-xl">
                ...
                <p>
                  Y para los más cancheros todavía: After Snow con gastronomía y música en vivo en
                  el parador exclusivo de <OldSchoolWord registered={false} />.
                </p>
                <p className="pt-4 font-black text-xl lg:text-2xl xl:text-3xl">
                  No es para todos.
                  <br />
                  Es para nosotros.
                </p>
