...
const paperPad =
  'relative border-b-4 border-black p-8 sm:p-10 lg:p-12 xl:p-16';
    ...
    <div ref={sectionRef} data-os-read-marker className="os-surface border-x-4 border-b-4 border-black">
      <div className="os-section-head-row">
        <div className="max-w-3xl">
          ...
          <h2 ref={titleRef} className="os-section-h2">
            VOLVEMOS A DONDE<br />LA MÚSICA LO<br />ACOMODABA TODO<br />DONDE TODO EXPLOTA
          </h2>
        </div>
      ...
      <div className="grid grid-cols-1 items-stretch border-b-4 border-black lg:grid-cols-[2fr_1fr]">
        <div className={`${paperPad} border-b-4 border-black lg:border-b-0 lg:border-r-4`}>
          <p className="os-body max-w-2xl lg:max-w-none">
            Visitamos las discotecas icónicas de Bariloche y revivimos la energía del viaje de egresados en versión{' '}
            <span className="font-black">Retro Premium</span>: hits 80/90/2000, puesta cinematográfica y noches pensadas
            para que el grupo se suelte, se ría y se lleve recuerdos reales.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div ref={setBlockRef(0)} className={`${paperPad} border-b-4 lg:border-r-4`}>
          ...
          <div className="os-brutal-num-sub mb-4">01</div>
        ...
        <div ref={setBlockRef(1)} className={`${paperPad}`}>
          <div className="os-asterisk-deco absolute right-8 top-8 text-4xl font-black">*</div>
          <div className="os-brutal-num-sub mb-4">02</div>
          ...
          <div className="space-y-3 border-l-4 border-black pl-5 lg:pl-6">
            <div className="space-y-3 os-body">
              <p>La fiesta del estudiante convertida en una de las noches más esperadas del viaje.</p>
      ...
      <div ref={setBlockRef(2)} className="os-band-orange relative border-b-4 border-black p-8 sm:p-10 lg:p-12 xl:p-16">
        <div className="os-asterisk-deco absolute right-8 top-8 text-4xl">*</div>
        <div className="os-brutal-num-sub mb-4">03</div>
        <h3 className="os-section-title mb-3 text-sm lg:text-base">Fiesta del Semáforo & Color Crush</h3>
        <div className="max-w-4xl space-y-3">
          ...
          <p className="os-body pt-3">
            <span className="font-black">Semáforo:</span> cada color representa un mood, un deseo, una intención.
            <br />
            Código de vestimenta: tu estado civil.
          </p>
          <p className="os-body">
            <span className="font-black">Color Crush:</span> entrás con un color, jugás con una vibra y dejás que la noche haga
            el resto.
            <br />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div ref={setBlockRef(3)} className="os-band-cyan relative border-b-4 border-black p-8 sm:p-10 lg:border-r-4 lg:border-b-0 lg:p-12 xl:p-16">
          <div className="os-asterisk-deco absolute right-8 top-8 text-4xl font-black">*</div>
          <div className="os-brutal-num-sub mb-4">04</div>
          ...
          <div className="space-y-3 os-body">
            ...
            <p>Neón, pantallas VHS, guiños a los 80/90/2000, show en vivo, Momento Generación y Clímax Colectivo.</p>
        ...
        <div ref={setBlockRef(4)} className={`${paperPad} border-b-0`}>
          <div className="os-asterisk-deco absolute right-8 top-8 text-4xl font-black">*</div>
          <div className="os-brutal-num-sub mb-4">05</div>
          ...
          <div className="space-y-3 border-l-4 border-[var(--os-orange)] pl-5 lg:pl-6">
            <div className="space-y-3 os-body">
              <p>Conducción en vivo, tribunas, desafíos, karaoke y juegos que te hacen gritar de risa.</p>
              <p className="os-body-strong font-black">Si te animás, te convertís en protagonista.</p>
            </div>
          </div>
        </div>
      </div>
