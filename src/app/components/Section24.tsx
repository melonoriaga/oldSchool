...
export function Section24({ onPostular }: Section24Props) {
  ...
  return (
    <div ref={sectionRef} id="precio" data-os-read-marker className="os-surface border-x-4 border-b-4 border-black">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12">
        <div className="os-band-cyan border-b-4 border-black p-6 sm:p-8 lg:col-span-5 lg:border-b-0 lg:border-r-4 lg:p-12">
          <p ref={el => textRefs.current[0] = el} className="os-section-title text-lg sm:text-xl lg:text-2xl">
            ESTO NO ES BARATO.
          </p>
          <p ref={el => textRefs.current[1] = el} className="os-pull mt-4 border-l-4 border-black pl-4 text-black sm:pl-5">
        ...
        <div className="space-y-5 p-6 sm:p-8 lg:col-span-7 lg:p-12">
          ...
          <p ref={el => textRefs.current[3] = el} className="os-slice border-l-4 border-[var(--os-orange)] pl-4 sm:pl-5">
            No es una promoción.
          </p>
          <p ref={el => textRefs.current[4] = el} className="os-pull pt-2 text-base sm:text-lg lg:text-2xl">
            Es una experiencia diseñada a medida de un concepto:
          </p>
          <p ref={el => textRefs.current[5] = el} className="os-section-title border-l-4 border-black pl-4 text-2xl sm:pl-5 sm:text-3xl lg:text-4xl">
            <span className="text-[var(--os-orange)]">REGRESADOS.</span>
          </p>
        </div>

        <div ref={buttonRef} className="border-t-4 border-black bg-black/[0.03] p-6 sm:p-8 lg:col-span-12 lg:p-10">
          <button
            type="button"
            onClick={onPostular}
