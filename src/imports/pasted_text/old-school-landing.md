OLD SCHOOL — LANDING DEFINITIVA

1.  SI VIAJASTE A BARILCOHE CON TU CURSO, ESTO ES PARA VOS.

NO ES UN VIAJE, ES UN REGRESO.
El viaje de egresados se hace una sola vez en la vida. Hasta ahora.
Porque hay algo que no se repite nunca más, la versión de vos que fuiste ahí.
...
2.  Hubo un momento en tu vida en el que no estabas pensando tanto.
    Estabas viviendo.
...
3.  NO ES NOSTALGIA, ES RECONEXIÓN.
    Old School no está hecho para mirar el pasado desde afuera.
    Está hecho para volver a entrar.
    No es recordar.
    Es reactivar.
    No es mirar lo que fue.
...
5.  NO EXTRAÑÁS EL DESTINO, EXTRAÑÁS TU LATIDO.
    Lo que extrañás del viaje de egresados no es solo el destino.
    Extrañás cómo latía tu vida cuando eras libre.
    Volver a vos es recuperar esa versión tuya:
    liviana, valiente, presente, viva.
    La que se emocionaba sin vergüenza.

6.  BARILOCHE NO ES UN LUGAR. ES UN SÍMBOLO.
...
7.  REGRESADOS
    CADA GENERACIÓN LO VIVIÓ DISTINTO, PERO TODAS SINTIERON LO MISMO.
...
10. FORMATO EXCLUSIVO
    Old School® no es un viaje abierto.
    Cada edición se organiza para grupos limitados de regresados.
    • Cupos reducidos
    • Producción premium
    • Universo musical y estética con identidad propia
    • Momentos diseñados escena por escena
...
11. LO DISEÑAMOS DE MEMORIA. COMO UNA PELÍCULA.
    Lo hicimos mil veces.
    Y ahora lo hacemos para vos, en versión premium.
    Haber organizado más de un millón de viajes de egresados desde 1990 nos da algo que no se improvisa: oficio.
...
12. LA CÁPSULA DEL TIEMPO ARRANCA EN EL AVIÓN.
...
13. EL SISTEMA INVISIBLE
    ...
    Para excursiones y discotecas contamos con unidades receptivas modernas, habilitadas y una flota exclusiva de última generación que aporta confort, calidad y tranquilidad durante toda la estadía.

14. DONDE EMPIEZA TODO
...
15. DONDE SE CONSTRUYE TODO
    La comida no es comida.
    Es mezcla.
    Es grupo.
    Es banda.
...
16. LAS EXCURSIONES QUE HICIERON HISTORIA.
    La misma alegría.
    La misma sorpresa.
    Pero en versión Old School.
    City Hall, Chico & Punto
    La primera gran señal de que ya llegaste.
    Centro Cívico, activación de grupo, búsqueda del tesoro y después Circuito Chico entre lagos, bosques y curvas de postal.
    El cierre en Punto Panorámico pega en el pecho.
    Ahí sale una de las fotos más legendarias del viaje.
    Día de Campo
    Cabalgatas, juegos, competencias grupales y asado libre al pie de la montaña.
    Y cuando parece que el día terminó, lo cerramos con sunset cervecero y show en vivo.
    Old School ® Festival
    No es un show más.
    Es un ritual colectivo en el bosque.
    Propuesta gastronómica de montaña, pileta climatizada convertida en discoteca, fiesta de la espuma, DJs en vivo, happy hours, Old School Rock y cierre con Sunset We Color.
    Trineos Patagonia 360
    Adrenalina segura.
    Aerosilla, charla rápida de seguridad, circuito armado, risas, montaña y diversión real.
    Te subís al trineo… y arranca la bajada.
    Cerro Catedral & Gruta Virgen de las Nieves
    El día que te queda para siempre.
    Montaña, nieve, aire helado en la cara y el grupo viviendo algo enorme.
    Miradores, tiempo para recorrer, ski & snowboard con instructores y pases.
    Y para los más cancheros todavía: After Snow con gastronomía y música en vivo en el parador exclusivo de Old School.
    No es para todos.
    Es para nosotros.

17. VOLVEMOS A DONDE LA MÚSICA LO ACOMODABA TODO. DONDE TODO EXPLOTA.
    Visitamos las discotecas icónicas de Bariloche y revivimos la energía del viaje de egresados en versión Retro Premium: hits 80/90/2000, puesta cinematográfica y noches pensadas para que el grupo se suelte, se ría y se lleve recuerdos reales.
    Fiesta de Disfraces
    Disfraces, personajes, música, pasarela, desafíos y premios.
    Una noche para soltarse y reírse sin filtro.
    Código de Vestimenta: Disfraces.
    Fiesta Colegial
    La fiesta del estudiante convertida en una de las noches más esperadas del viaje.
    DJ en vivo, luces, hits y energía de egresados desde que entrás.
    Código de Vestimenta: Estudiantil Retro.
    Fiesta del Semáforo & Color Crush
    Dos conceptos en una noche.
    Primero el código. Después la vibra.
    Una propuesta pensada para conectar de verdad.
    Semáforo: cada color representa un mood, un deseo, una intención.
    Código de vestimenta: tu estado civil.
    Color Crush: entrás con un color, jugás con una vibra y dejás que la noche haga el resto.
    Código de vestimenta: tu vibra romántica.
    Super Retro Show
    Fiesta temática inmersiva.
    Neón, pantallas VHS, guiños a los 80/90/2000, show en vivo, Momento Generación y Clímax Colectivo.
    No es nostalgia pasiva.
    Es volver a entrar en una versión tuya que seguía intacta.
    Código de Vestimenta: Retro.
    EVENTOS ESPECIALES
    Conducción en vivo, tribunas, desafíos, karaoke y juegos que te hacen gritar de risa.
    Si te animás, te convertís en protagonista.

18. RECUERDOS DISEÑADOS PARA QUEDARSE.
...
23. FAQ (CLAVE DE CONVERSIÓN)
    (responder objeciones reales, COLOCAR PREGUNTAS Y RESPUESTAS)

24. NO TIENE PRECIO, TIENE VALOR.
    Esto no es barato.
...
26. Vos no estabas buscando un viaje.
    Estabas buscando una prueba de que todavía estás ahí.

27. Esto no es inscripción.
    Es postulación.

28. WHATSAPP
    ¿Qué parte te hizo sentir que esto es para vos?

29. FOOTER + PROTECCIÓN
    Old School — Regresados
    Formato experiencial original.
    Sistema registrado.
    Identidad protegida.
